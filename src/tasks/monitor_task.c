...
void MonitorPrc(void){
	...
	ShowTaskList();
#endif
//	VisualScope(UART8,20000+19*BULLET_SPEED_TO_MOTOR_SPEED,20000+GetMotorData(FRIC2_MOTOR).speed,20000+GetMotorData(FRIC2_MOTOR).torque,20000+GetMotorData(FRIC0_MOTOR).speed);//2000+HFric1_SpeedPID.output,2000+HFric2_SpeedPID.output);
}
